...
namespace Syncer.Flows.Payments
{
    ...
    public class ProductAttributeLineDeleteFlow
        : DeleteSyncFlow
    {
        public ProductAttributeLineDeleteFlow(SyncServiceCollection svc)
            : base(svc)
        { }
        ...
        {
            SimpleDeleteInStudio<fsonproduct_attribute_line>(onlineID);
        }
    }
}
