...
namespace Syncer.Flows.Payments
{
    ...
    public class SaleOrderDeleteFlow
        : DeleteSyncFlow
    {
        public SaleOrderDeleteFlow(ILogger logger, OdooService odooService, SosyncOptions conf, FlowService flowService) : base(logger, odooService, conf, flowService)
        {
        }
        ...
        {
            SimpleDeleteInStudio<fsonsale_order>(onlineID);
        }
    }
}
