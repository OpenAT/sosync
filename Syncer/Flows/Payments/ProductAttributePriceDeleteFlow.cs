...
namespace Syncer.Flows.Payments
{
    ...
    public class ProductAttributePriceDeleteFlow
        : DeleteSyncFlow
    {
        public ProductAttributePriceDeleteFlow(SyncServiceCollection svc)
            : base(svc)
        { }
        ...
        {
            SimpleDeleteInStudio<fsonproduct_attribute_price>(onlineID);
        }
    }
}
