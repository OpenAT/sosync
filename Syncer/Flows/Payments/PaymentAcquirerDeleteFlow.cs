...
namespace Syncer.Flows.Payments
{
    ...
    public class PaymentAcquirerDeleteFlow
        : DeleteSyncFlow
    {
        public PaymentAcquirerDeleteFlow(ILogger logger, OdooService odooService, SosyncOptions conf, FlowService flowService) : base(logger, odooService, conf, flowService)
        {
        }
