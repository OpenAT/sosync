...
namespace Syncer.Flows.Payments
{
    ...
    public class ProductProductDeleteFlow
        : DeleteSyncFlow
    {
        public ProductProductDeleteFlow(ILogger logger, OdooService odooService, SosyncOptions conf, FlowService flowService) : base(logger, odooService, conf, flowService)
        {
        }
